...
public class Usuarios extends SQLiteOpenHelper
{
    ...
    String sqlCreate = "CREATE TABLE USERS("+"idUsuario INTEGER PRIMARY KEY AUTOINCREMENT,"+"usuario TEXT,"+"contrasena TEXT,"+"recontrasena TEXT,"+"email TEXT,"+"estatura TEXT,"+"peso TEXT)";
